      ...
      case 2:
        {
          ...
          if (properties_manager.is_non_newtonian())
            {
              // Calculate derivative of viscosity with respect to shear rate
              rheology_model_0->vector_jacobian(
                fields,
                field::shear_rate,
                grad_kinematic_viscosity_shear_rate_0);

              rheology_model_1->vector_jacobian(
                fields,
                field::shear_rate,
                grad_kinematic_viscosity_shear_rate_1);
            }
              ...
              for (unsigned int q = 0; q < this->n_q_points; ++q)
                {
                  ...
                  kinematic_viscosity_scale =
                    calculate_point_property_cahn_hilliard(
                      phase_order_cahn_hilliard_value,
                      this->kinematic_viscosity_scale_0,
                      this->kinematic_viscosity_scale_1);

                  // kinematic_viscosity_scale =
                  // std::max(this->grad_kinematic_viscosity_shear_rate_0[q],this->grad_kinematic_viscosity_shear_rate_1[q]);
                  // kinematic_viscosity_scale =
                  // std::min(this->grad_kinematic_viscosity_shear_rate_0[q],this->grad_kinematic_viscosity_shear_rate_1[q]);
                  // kinematic_viscosity_scale =
                  // 0.5*(this->grad_kinematic_viscosity_shear_rate_0[q] +
                  // this->grad_kinematic_viscosity_shear_rate_1[q]);
                  // kinematic_viscosity_scale =
                  // 2*(this->grad_kinematic_viscosity_shear_rate_0[q]*this->grad_kinematic_viscosity_shear_rate_1[q])/(this->grad_kinematic_viscosity_shear_rate_0[q]
                  // + this->grad_kinematic_viscosity_shear_rate_1[q]);
                  // kinematic_viscosity_scale =
                  // std::pow(0.5*(this->grad_kinematic_viscosity_shear_rate_0[q]*this->grad_kinematic_viscosity_shear_rate_0[q]
                  // +
                  // this->grad_kinematic_viscosity_shear_rate_1[q]*this->grad_kinematic_viscosity_shear_rate_1[q]),0.5);
                }
              break;
            }
          break;
